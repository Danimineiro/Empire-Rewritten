...
{
    /// <summary>
    ///     A type of <see cref="Process" /> used to construct a new <see cref="Facility" /> inside a
    ...
    internal class FacilityBuildProcess : Process, IProcessSlotID
    {
        ...
        /// <summary>
        ///     Overrides <see cref="Process.Run" />; Builds a new <see cref="Facility" />, or adds to it using
        ///     <see cref="Facility.AddFacility" /> if it already exists, inside the given <see cref="FacilityManager" />
        ///     <paramref name="facilityManager" /> using the <see cref="FacilityDef" /> <paramref name="facilityDef" />; Notifies
        ///     the <see cref="facilityManager" />
        /// </summary>

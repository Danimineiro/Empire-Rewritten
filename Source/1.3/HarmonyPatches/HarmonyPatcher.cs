...
namespace Empire_Rewritten.HarmonyPatches
{
    public static class HarmonyPatcher
    {
        ...
        public static void DoPatches()
        {
            ...
            harmony.Patch(typeof(Settlement).GetMethod(nameof(Settlement.GetGizmos)), postfix: new HarmonyMethod(typeof(SettlementGizmoPatch), nameof(SettlementGizmoPatch.GizmoPatch)));
